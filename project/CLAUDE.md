...
| Gold Dimension | `statestreet` | `g_statestreet` | `statestreet.g_statestreet.dim_<name>` |
| Gold Fact | `statestreet` | `g_statestreet` | `statestreet.g_statestreet.fact_<name>` |

### Table Names
- **Bronze and Silver**: keep original CSV file names exactly (e.g. `product`, `bond`, `stock`)
- **Gold dimensions**: `dim_<name>` (e.g. `dim_product`, `dim_legal_entity`)
- **Gold facts**: `fact_<name>` (e.g. `fact_product_rating`, `fact_coupon_schedule`)
